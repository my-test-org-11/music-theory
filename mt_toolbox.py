...
all_scale_info = {
    ...
    "Double_harmonic"   : {"signature" : [S,T*S,S,T,S,T*S,S],           "info" : "Double harmonic major scale. AKA Byzantine scale"},
    "Hungarian_minor"   : {"signature" : [T,S,T*S,S,S,T*S,S],           "info" : "AKA Double Harmonic minor scale.Lydian of the Double harmonic major scale"},
